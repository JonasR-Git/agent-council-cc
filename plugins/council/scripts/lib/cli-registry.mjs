...
export const CLI_FLAGS = [
  ...
  { flag: "structure-first", type: "boolean", verbs: ["audit"], block: "fix", configKey: "structure_first", validate: null, negatable: true, negOrder: 12, aliasOf: null, mutationClass: "none", help: "run structure/SSOT/code-reduction tiers BEFORE correctness (needs --structure-auto-apply; default: correctness-first)" },
